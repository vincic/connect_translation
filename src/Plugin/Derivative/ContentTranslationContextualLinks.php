...
/**
 * @file
 * Contains \Drupal\connect_translation\Plugin\Derivative\ContentTranslationContextualLinks.
 */
...
class ContentTranslationContextualLinks extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    foreach ($this->contentTranslationManager->getSupportedEntityTypes() as $entity_type_id => $entity_type) {
      ...
      $this->derivatives[$entity_type_id]['title'] = t('Connect Translate');
      $this->derivatives[$entity_type_id]['route_name'] = "entity.$entity_type_id.connect_translation_overview";
