...
/**
 * @file
 * Contains \Drupal\connect_translation\Routing\ContentTranslationRouteSubscriber.
 */

namespace Drupal\connect_translation\Routing;
 ...
 */
class ConnectTranslationRouteSubscriber extends RouteSubscriberBase {
  ...
  protected function alterRoutes(RouteCollection $collection) {
    foreach ($this->contentTranslationManager->getSupportedEntityTypes() as $entity_type_id => $entity_type) {
      ...
      $route = new Route(
        $path,
        array(
          '_controller' => '\Drupal\connect_translation\Controller\ConnectTranslationController::overview',
      ...
      $route_name = "entity.$entity_type_id.connect_translation_overview";
      $collection->add($route_name, $route);

      $route = new Route(
        $path . '/add/{source}/{target}/{target_node_id}',
        array(
          '_controller' => '\Drupal\connect_translation\Controller\ConnectTranslationController::add',
          'source' => NULL,
          'target' => NULL,
          'target_node_id' => $entity_type_id,
          '_title' => 'Add',
          'entity_type_id' => $entity_type_id,
      ...
      $collection->add("connect_translation.translation_connect_$entity_type_id", $route);
